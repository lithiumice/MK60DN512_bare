...
{
private:
    // uint32  uart_baud = 115200;
    // uint32  uart_baud = 460800;
...
public:
    ...
    void init(uint32 uart_baud = 115200)
    {
        // uart_init(USART_3, uart_baud, UART3_TX_C8, UART3_RX_C9);
        uart_init(USART_8, uart_baud, UART8_TX_D16, UART8_RX_D17);
    }
    ...
    void send_vscope_4(int16 data1, int16 data2, int16 data3, int16 data4)
    {
        uint8 *dat = vscope_data_buff;
        uint16 CRC16 = 0;
