...
// {
//     // return 1000 * pit_time_get(pit3);
//     return systick_getval() / core_clk_mhz;
// }

// inline uint32 millis()
// {
//   return systick_getval() / (100 * 1000);
//   // return systick_getval() / (core_clk_mhz * 1000);
// }

// inline uint64 micros(void)
// {
//     return sys_tick_ms*1000;
// }

// inline uint64 millis(void)
// {
//     return sys_tick_ms;
// }
...
/**
  ...
  * @retval 无
  */
#define PUSH_PULL(fifo, len, value)    \
  {                                    \
...
/**
  ...
  * @retval 无
  */
#define CLR_ARG(addr) memset(addr, 0, sizeof(addr));
